...
public class MessageConsumer {
  ...
  @RabbitListener(queues = "${app.rabbitmq.queue-one:orders.fanout.queue.one}")
  public void consumeFromQueueOne(OrderMessage message) {
    processMessage(message);
  }

  @RabbitListener(queues = "${app.rabbitmq.queue-two:orders.fanout.queue.two}")
  public void consumeFromQueueTwo(OrderMessage message) {
    processMessage(message);
  }
