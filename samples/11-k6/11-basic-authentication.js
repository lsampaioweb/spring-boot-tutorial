...
export default function () {
  ...
  // Passing username and password as part of the URL will allow us to authenticate using HTTP Basic Auth.
  ...
  response = http.get(`https://httpbin.test.k6.io/basic-auth/${username}/${password}`, options);
